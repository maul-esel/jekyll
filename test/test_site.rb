...
class TestSite < Test::Unit::TestCase
  context "configuring sites" do
    should "have an array for plugins by default" do
      ...
      assert_equal [File.join(Dir.pwd, '_plugins')], PluginManager.plugins_path
    end
  ...
  context "creating sites" do
    ...
    should "setup plugins in priority order" do
      assert_equal PluginManager.converters.sort_by(&:class).map{|c|c.class.priority}, PluginManager.converters.map{|c|c.class.priority}
      assert_equal PluginManager.generators.sort_by(&:class).map{|g|g.class.priority}, PluginManager.generators.map{|g|g.class.priority}
    end
